...
function createArticle(articleData) {
  const section = document.getElementById("pictures"); // Use the correct ID
  ...
  image.src = articleData.image.medium; // Correct property
  image.alt = articleData.title;

  const figcaption = document.createElement("figcaption");
  figcaption.textContent = articleData.caption; // Correct property
